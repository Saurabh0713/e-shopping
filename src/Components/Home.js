...
export default function Home() {
  return (
    <div className=' pt-14 w-full h-max bg-zinc-700' id='home'>
     <div className=' w-full h-full min-h-screen flex flex-col justify-center items-center md:flex md:flex-row md:items-center md:justify-around bg-gradient-to-r from-amber-500 to-blue-500'>
